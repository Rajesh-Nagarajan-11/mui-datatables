...
import type { MUIDataTableColumn, MUIDataTableComponents, MUIDataTableData, MUIDataTableOptions } from './types';

export interface MUIDataTablePublicProps {
  /** Title of the table */
  title?: ReactNode;
...
interface MUIDataTableProps extends MUIDataTablePublicProps {
  classes: Record<string, string>;
}

const defaultTableStyles = (theme: any) =>
  ({
    root: {
      '& .datatables-noprint': {
        '@media print': {
...
class MUIDataTable extends React.Component<MUIDataTableProps> {
  static propTypes = {
    /** Title of the table */
